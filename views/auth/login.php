...
<div class="login-card">
    ...
    <form action="<?= url('login') ?>" method="POST" autocomplete="off">
        ...
        <div class="mb-3">
            ...
            <input 
                ...
                autofocus
            >
            <div style="font-size: 0.75rem; color: #94a3b8; margin-top: 0.25rem;">Max 10 alphanumeric characters</div>
        </div>
    ...
    <!-- Quick Demo Switcher -->
    <div class="mt-4 pt-3" style="border-top: 1px dashed #e2e8f0; text-align: center;">
        <div style="font-size: 0.78rem; color: #64748b; margin-bottom: 0.5rem;">Click demo account to auto-fill:</div>
        <div class="d-flex justify-content-center gap-2 flex-wrap">
            <button type="button" class="demo-pill" onclick="fillCreds('cashier01')">Cashier</button>
            <button type="button" class="demo-pill" onclick="fillCreds('manager01')">Manager</button>
            <button type="button" class="demo-pill" onclick="fillCreds('superadmin')">Super Admin</button>
        </div>
        <div style="font-size: 0.72rem; color: #94a3b8; margin-top: 0.4rem;">Password: <code>password123</code></div>
    </div>
</div>

<script>
function fillCreds(user) {
